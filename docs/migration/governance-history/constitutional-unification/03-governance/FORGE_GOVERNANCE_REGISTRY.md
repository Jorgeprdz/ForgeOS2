...
| Root Constitution anchor | `docs/migration/constitutional-history/FORGE_CONSTITUTION_V3.md` | Root-level constitutional authority anchor. |
| Constitution map | `governance/constitution/FORGE_CONSTITUTION_MAP.md` | Maps constitutional layers and ADR authority flow. |
...
| Build Tree | `governance/architecture/FORGE_MASTER_BUILD_TREE.md` | Canonical project area and status map. |
...
| ROBOCOP directives | `governance/validation/FORGE_ROBOCOP_DIRECTIVES.md` | Mandatory pre-work gate. |
