...
- Current `docs/migration/constitutional-history/FORGE_CONSTITUTION_V3.md` and `AGENTS.md`.
- `ARTICLE_0_RATIFICATION_001.md`, explicit ratification and certificate pattern, and Build Tree Article 0 status.
- `governance/constitution/FORGE_CONSTITUTION_MAP.md` and current `governance/architecture/FORGE_MASTER_BUILD_TREE.md`.
