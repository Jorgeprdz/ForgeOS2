...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `docs/02-adr-candidates/PAQ-01-RECRUITMENT-INTELLIGENCE-DISCOVERY.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 2 | `docs/02-adr-candidates/PAQ-02-RECRUITMENT-DOMAIN-MODEL-ADDENDUM.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 3 | `docs/02-adr-candidates/PAQ-02-RECRUITMENT-DOMAIN-MODEL.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 4 | `docs/02-adr-candidates/PAQ-03-CAREER-CAPITAL-RELATIONSHIP-CAPITAL-BOUNDARY-REVIEW.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 5 | `docs/02-adr-candidates/PAQ-04-METRICS-OWNERSHIP-FINALIZATION.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 6 | `docs/02-adr-candidates/PAQ-04-P200-MARKET-NATURAL-DISCOVERY-REVIEW.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 7 | `docs/02-adr-candidates/PAQ-05-RELATIONSHIP-ACTIVATION-REVIEW.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 8 | `docs/02-adr-candidates/PAQ-05-RULE-SNAPSHOT-HARDENING.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 9 | `docs/02-adr-candidates/PAQ-06-COMMERCIAL-EVENTS-TAXONOMY.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 10 | `docs/02-adr-candidates/PAQ-06-RECRUITMENT-HARDENING-REVIEW.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 11 | `docs/02-adr-candidates/PAQ-07-FOUNDATION-LOCK-REVIEW.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | PRESERVE_HISTORICAL_LINK | WAVE-B | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 12 | `docs/02-adr-candidates/PAQ-07-PARTNER-INTELLIGENCE-DISCOVERY.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 13 | `docs/02-adr-candidates/PAQ-08-ADVISOR-DEVELOPMENT-INTELLIGENCE-DISCOVERY.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 14 | `docs/02-adr-candidates/PAQ-08-FOUNDATION-LOCK-FINAL-REVIEW.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | PRESERVE_HISTORICAL_LINK | WAVE-B | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 15 | `docs/02-adr-candidates/PAQ-09-PRODUCTIVITY-INTELLIGENCE-DISCOVERY.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 16 | `docs/02-adr-candidates/PAQ-09.5-PRODUCTIVITY-INTELLIGENCE-ARCHITECTURE-LOCK.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 17 | `docs/02-adr-candidates/PAQ-10-CONSERVATION-INTELLIGENCE-DISCOVERY.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 18 | `docs/02-adr-candidates/PAQ-10.5-CONSERVATION-INTELLIGENCE-ARCHITECTURE-LOCK.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 19 | `docs/02-adr-candidates/PAQ-12-ADVISOR-EXPERIENCE-INTELLIGENCE-PRODUCTIVITY.md` | `FORGE_ADVISOR_EXPERIENCE_ARCHITECTURE.md` | `docs/99-archive/FORGE_ADVISOR_EXPERIENCE_ARCHITECTURE.md` | `docs/99-archive/FORGE_ADVISOR_EXPERIENCE_ARCHITECTURE.md` | ARCHIVE_REDIRECT | Archive + Advisor OS | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 20 | `docs/02-adr-candidates/PAQ-12-ADVISOR-EXPERIENCE-INTELLIGENCE-PRODUCTIVITY.md` | `SCHEMA_CATALOG.md` | `docs/99-archive/SCHEMA_CATALOG.md` | `docs/99-archive/SCHEMA_CATALOG.md` | ARCHIVE_REDIRECT | Archive + Repository Governance | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 21 | `docs/02-adr-candidates/PAQ-12.1-ADVISOR-EXPERIENCE-INTELLIGENCE-ARCHITECTURE.md` | `FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | `docs/99-archive/FORGE_FOUNDATION_LOCK.md` | HISTORICAL_REFERENCE | Archive + Constitution | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
| 22 | `docs/02-adr-candidates/PAQ-12.1-ADVISOR-EXPERIENCE-INTELLIGENCE-ARCHITECTURE.md` | `FORGE_ADVISOR_EXPERIENCE_ARCHITECTURE.md` | `docs/99-archive/FORGE_ADVISOR_EXPERIENCE_ARCHITECTURE.md` | `docs/99-archive/FORGE_ADVISOR_EXPERIENCE_ARCHITECTURE.md` | ARCHIVE_REDIRECT | Archive + Advisor OS | SAFE_TO_REDIRECT | WAVE-A | Shared historical target; Archive owns storage, domain owner owns meaning. |
