...
window.FORGE_SAMPLE_DATA = Object.freeze({
  ...
  bottleneck: {
    title: 'Cuello de botella del día',
    message: '3 oportunidades de muestra necesitan seguimiento antes de enfriarse.',
    severity: 'Alta',
    reasonWhy: 'La velocidad de seguimiento es la señal más accionable para hoy.',
    nextReviewAction: 'Revisar el plan del día',
  },
  monthlyGoal: {
    label: 'Meta mensual de muestra',
    progress: '64%',
    protectedFamilies: '6 / 10',
    sampleAmount: '$142,000',
  },
  opportunities: [
