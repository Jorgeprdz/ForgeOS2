...
- `python3 -m json.tool docs/evidence/forge-quote-preview-pdf-engine-canonical-execution-readiness-review-qa-audit-080c.json`
- marker scan
- `git diff --check`
- scoped safety scan
