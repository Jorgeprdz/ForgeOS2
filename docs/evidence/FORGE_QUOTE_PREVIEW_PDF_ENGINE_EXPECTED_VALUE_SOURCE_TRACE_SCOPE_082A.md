...
```json
{
  ...
  "base_readiness_gate": "expected_value_source_trace_ready",
  "base_readiness_gate_status": "not_ready",
  "base_readiness_decision": "not_ready_for_execution",
  "overall_readiness_before_082a": "not_ready_for_execution",
  "file_hash_registry_status_before_082a": "not_bound_not_verified_not_ready",
  ...
  "source_registry_refs": {
    ...
    "file_hash": {
      ...
      "schemaVersion": "forge.quote_preview.pdf_engine.real_pdf_file_hash_provenance.registry.v1",
...
- `python3 -m json.tool docs/evidence/forge-quote-preview-pdf-engine-expected-value-source-trace-scope-audit-082a.json`
- marker scan
- `git diff --check`
- scoped safety scan
