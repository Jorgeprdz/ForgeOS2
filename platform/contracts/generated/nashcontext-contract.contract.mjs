...
// Source: scaffolds/artifacts/SG-004/nashcontext-contract.artifact.json
// Artifact: NASHContextContract
// Stage: SG-004
// Source SHA-256: e7fea0c6b47ebcb443fb12febccd3959c0a82290c287e3dc3bb36f1a7e67b85a

const contract = Object.freeze({
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "artifact_id": "NASHContextContract",
  "artifact_slug": "nashcontext-contract",
  "stage_id": "SG-004",
  ...
  "generated_at": "2026-07-23T00:04:32.349690+00:00",
  ...
  "fail_closed": true,
  "materialization": {
    "path": "scaffolds/artifacts/SG-004/nashcontext-contract.artifact.json",
...
export const artifactId = "NASHContextContract";
export const stageId = "SG-004";
export const sourceDigest = "e7fea0c6b47ebcb443fb12febccd3959c0a82290c287e3dc3bb36f1a7e67b85a";
...
export function assertFunctionalImplementationAllowed() {
  if (implementationStatus !== 'FUNCTIONAL_IMPLEMENTATION_ALLOWED') {
    throw new Error(
      'FORGE_FUNCTIONAL_IMPLEMENTATION_NOT_AUTHORIZED:NASHContextContract'
    );
  }
