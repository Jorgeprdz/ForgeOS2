...
// Source: scaffolds/artifacts/SG-004/nashboundary-contract.artifact.json
// Artifact: NASHBoundaryContract
// Stage: SG-004
// Source SHA-256: 09b2cfaa1abd5123ca34de66342c891fa129a6cd5ab2f89ed5c8b353c5f01fd4

const contract = Object.freeze({
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "artifact_id": "NASHBoundaryContract",
  "artifact_slug": "nashboundary-contract",
  "stage_id": "SG-004",
  ...
  "generated_at": "2026-07-23T00:04:32.340465+00:00",
  ...
  "fail_closed": true,
  "materialization": {
    "path": "scaffolds/artifacts/SG-004/nashboundary-contract.artifact.json",
...
export const artifactId = "NASHBoundaryContract";
export const stageId = "SG-004";
export const sourceDigest = "09b2cfaa1abd5123ca34de66342c891fa129a6cd5ab2f89ed5c8b353c5f01fd4";
...
export function assertFunctionalImplementationAllowed() {
  if (implementationStatus !== 'FUNCTIONAL_IMPLEMENTATION_ALLOWED') {
    throw new Error(
      'FORGE_FUNCTIONAL_IMPLEMENTATION_NOT_AUTHORIZED:NASHBoundaryContract'
    );
  }
