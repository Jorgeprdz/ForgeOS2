...
// Source: scaffolds/artifacts/SG-026/event-receipt-contract.artifact.json
// Artifact: EventReceiptContract
// Stage: SG-026
// Source SHA-256: 34dcee770bc972312b4f3903004852b332329372c15422703206ca4042e4f166

const contract = Object.freeze({
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "artifact_id": "EventReceiptContract",
  "artifact_slug": "event-receipt-contract",
  "stage_id": "SG-026",
  ...
  "generated_at": "2026-07-22T23:58:05.109561+00:00",
  ...
  "fail_closed": true,
  "materialization": {
    "path": "scaffolds/artifacts/SG-026/event-receipt-contract.artifact.json",
...
export const artifactId = "EventReceiptContract";
export const stageId = "SG-026";
export const sourceDigest = "34dcee770bc972312b4f3903004852b332329372c15422703206ca4042e4f166";
...
export function assertFunctionalImplementationAllowed() {
  if (implementationStatus !== 'FUNCTIONAL_IMPLEMENTATION_ALLOWED') {
    throw new Error(
      'FORGE_FUNCTIONAL_IMPLEMENTATION_NOT_AUTHORIZED:EventReceiptContract'
    );
  }
