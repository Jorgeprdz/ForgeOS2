...
// Source: scaffolds/artifacts/SG-022/identity-alias-policy.artifact.json
// Artifact: IdentityAliasPolicy
// Stage: SG-022
// Source SHA-256: c07542dc22cba12705505718f58ec3a651f89e3969ab86e93d6cb265b1560f9c

const contract = Object.freeze({
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "artifact_id": "IdentityAliasPolicy",
  "artifact_slug": "identity-alias-policy",
  "stage_id": "SG-022",
  ...
  "generated_at": "2026-07-22T23:51:39.312402+00:00",
  ...
  "fail_closed": true,
  "materialization": {
    "path": "scaffolds/artifacts/SG-022/identity-alias-policy.artifact.json",
...
export const artifactId = "IdentityAliasPolicy";
export const stageId = "SG-022";
export const sourceDigest = "c07542dc22cba12705505718f58ec3a651f89e3969ab86e93d6cb265b1560f9c";
...
export function assertFunctionalImplementationAllowed() {
  if (implementationStatus !== 'FUNCTIONAL_IMPLEMENTATION_ALLOWED') {
    throw new Error(
      'FORGE_FUNCTIONAL_IMPLEMENTATION_NOT_AUTHORIZED:IdentityAliasPolicy'
    );
  }
