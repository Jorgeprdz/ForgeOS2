...
// Source: scaffolds/artifacts/SG-001/robocop-gate-contract.artifact.json
// Artifact: RobocopGateContract
// Stage: SG-001
// Source SHA-256: 2cdea19d13119c48bee37ccb0817fe26185fdc8e4323bb5e296a5de1aebc33a0

const contract = Object.freeze({
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "artifact_id": "RobocopGateContract",
  "artifact_slug": "robocop-gate-contract",
  "stage_id": "SG-001",
  ...
  "generated_at": "2026-07-23T03:34:38.193413+00:00",
  ...
  "fail_closed": true,
  "materialization": {
    "path": "scaffolds/artifacts/SG-001/robocop-gate-contract.artifact.json",
...
export const artifactId = "RobocopGateContract";
export const stageId = "SG-001";
export const sourceDigest = "2cdea19d13119c48bee37ccb0817fe26185fdc8e4323bb5e296a5de1aebc33a0";
...
export function assertFunctionalImplementationAllowed() {
  if (implementationStatus !== 'FUNCTIONAL_IMPLEMENTATION_ALLOWED') {
    throw new Error(
      'FORGE_FUNCTIONAL_IMPLEMENTATION_NOT_AUTHORIZED:RobocopGateContract'
    );
  }
