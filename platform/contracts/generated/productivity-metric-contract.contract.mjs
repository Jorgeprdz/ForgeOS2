...
// Source: scaffolds/artifacts/SG-023/productivity-metric-contract.artifact.json
// Artifact: ProductivityMetricContract
// Stage: SG-023
// Source SHA-256: 743ba2ddf7fe66f8ccbf2b0e36782e2b00eb63581645fe072c4759756ee98d2e

const contract = Object.freeze({
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "artifact_id": "ProductivityMetricContract",
  "artifact_slug": "productivity-metric-contract",
  "stage_id": "SG-023",
  ...
  "generated_at": "2026-07-22T23:50:15.499567+00:00",
  ...
  "fail_closed": true,
  "materialization": {
    "path": "scaffolds/artifacts/SG-023/productivity-metric-contract.artifact.json",
...
export const artifactId = "ProductivityMetricContract";
export const stageId = "SG-023";
export const sourceDigest = "743ba2ddf7fe66f8ccbf2b0e36782e2b00eb63581645fe072c4759756ee98d2e";
...
export function assertFunctionalImplementationAllowed() {
  if (implementationStatus !== 'FUNCTIONAL_IMPLEMENTATION_ALLOWED') {
    throw new Error(
      'FORGE_FUNCTIONAL_IMPLEMENTATION_NOT_AUTHORIZED:ProductivityMetricContract'
    );
  }
