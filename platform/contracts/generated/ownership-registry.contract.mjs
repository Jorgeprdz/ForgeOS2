...
// Source: scaffolds/artifacts/SG-023/ownership-registry.artifact.json
// Artifact: OwnershipRegistry
// Stage: SG-023
// Source SHA-256: 45b7cd886db2ff3b7bccdd65e57dec750ffcc6ece527eb42bbc1e5f4c02bd99a

const contract = Object.freeze({
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "artifact_id": "OwnershipRegistry",
  "artifact_slug": "ownership-registry",
  "stage_id": "SG-023",
  ...
  "generated_at": "2026-07-22T23:50:15.479647+00:00",
  ...
  "fail_closed": true,
  "materialization": {
    "path": "scaffolds/artifacts/SG-023/ownership-registry.artifact.json",
...
export const artifactId = "OwnershipRegistry";
export const stageId = "SG-023";
export const sourceDigest = "45b7cd886db2ff3b7bccdd65e57dec750ffcc6ece527eb42bbc1e5f4c02bd99a";
...
export function assertFunctionalImplementationAllowed() {
  if (implementationStatus !== 'FUNCTIONAL_IMPLEMENTATION_ALLOWED') {
    throw new Error(
      'FORGE_FUNCTIONAL_IMPLEMENTATION_NOT_AUTHORIZED:OwnershipRegistry'
    );
  }
