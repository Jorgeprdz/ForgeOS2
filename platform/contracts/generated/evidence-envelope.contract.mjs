...
// Source: scaffolds/artifacts/SG-002/evidence-envelope.artifact.json
// Artifact: EvidenceEnvelope
// Stage: SG-002
// Source SHA-256: a69d6ecf138d0d436fe92f0c3b6a86492bf035b5c00bff5ff737a3acb37d5a64

const contract = Object.freeze({
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "artifact_id": "EvidenceEnvelope",
  "artifact_slug": "evidence-envelope",
  "stage_id": "SG-002",
  ...
  "purpose": "Defines the fail-closed envelope required to carry evidence without inventing or silently ratifying truth.",
  "implementation_behavior": "FORGE_SCAFFOLD_NOT_IMPLEMENTED",
  "fail_closed": true,
  "manual_execution_authority": false,
  "materialization": {
    "path": "scaffolds/artifacts/SG-002/evidence-envelope.artifact.json",
    "source_manifest": "scaffolds/manifest/rewrite-stages.json",
    "semantic_authority": "stage manifest"
  }
});

export const artifactId = "EvidenceEnvelope";
export const stageId = "SG-002";
export const sourceDigest = "a69d6ecf138d0d436fe92f0c3b6a86492bf035b5c00bff5ff737a3acb37d5a64";
...
export function assertFunctionalImplementationAllowed() {
  if (implementationStatus !== 'FUNCTIONAL_IMPLEMENTATION_ALLOWED') {
    throw new Error(
      'FORGE_FUNCTIONAL_IMPLEMENTATION_NOT_AUTHORIZED:EvidenceEnvelope'
    );
  }
