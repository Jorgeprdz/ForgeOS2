...
// Source: scaffolds/artifacts/SG-011/calculation-contract.artifact.json
// Artifact: CalculationContract
// Stage: SG-011
// Source SHA-256: 989fb2cb266d7d0ba3f8bebe15c31aa2c92f850347c2b4ec56a641933c96bc44

const contract = Object.freeze({
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "artifact_id": "CalculationContract",
  "artifact_slug": "calculation-contract",
  "stage_id": "SG-011",
  ...
  "generated_at": "2026-07-23T00:05:22.892859+00:00",
  ...
  "fail_closed": true,
  "materialization": {
    "path": "scaffolds/artifacts/SG-011/calculation-contract.artifact.json",
...
export const artifactId = "CalculationContract";
export const stageId = "SG-011";
export const sourceDigest = "989fb2cb266d7d0ba3f8bebe15c31aa2c92f850347c2b4ec56a641933c96bc44";
...
export function assertFunctionalImplementationAllowed() {
  if (implementationStatus !== 'FUNCTIONAL_IMPLEMENTATION_ALLOWED') {
    throw new Error(
      'FORGE_FUNCTIONAL_IMPLEMENTATION_NOT_AUTHORIZED:CalculationContract'
    );
  }
