...
// Source: scaffolds/artifacts/SG-009/rule-snapshot-contract.artifact.json
// Artifact: RuleSnapshotContract
// Stage: SG-009
// Source SHA-256: 8c16be7f2613c712e05bff6e9f8b4bfbebb5735ad90ffdfae8216d3cc62a67a7

const contract = Object.freeze({
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "artifact_id": "RuleSnapshotContract",
  "artifact_slug": "rule-snapshot-contract",
  "stage_id": "SG-009",
  ...
  "generated_at": "2026-07-23T00:00:23.008170+00:00",
  ...
  "fail_closed": true,
  "materialization": {
    "path": "scaffolds/artifacts/SG-009/rule-snapshot-contract.artifact.json",
...
export const artifactId = "RuleSnapshotContract";
export const stageId = "SG-009";
export const sourceDigest = "8c16be7f2613c712e05bff6e9f8b4bfbebb5735ad90ffdfae8216d3cc62a67a7";
...
export function assertFunctionalImplementationAllowed() {
  if (implementationStatus !== 'FUNCTIONAL_IMPLEMENTATION_ALLOWED') {
    throw new Error(
      'FORGE_FUNCTIONAL_IMPLEMENTATION_NOT_AUTHORIZED:RuleSnapshotContract'
    );
  }
