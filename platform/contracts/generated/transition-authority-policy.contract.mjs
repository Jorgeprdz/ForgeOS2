...
// Source: scaffolds/artifacts/SG-025/transition-authority-policy.artifact.json
// Artifact: TransitionAuthorityPolicy
// Stage: SG-025
// Source SHA-256: b028fceee0627859cefbb2ac10c7513203c812d96b8a70e2a0472ff7f031e6f4

const contract = Object.freeze({
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "artifact_id": "TransitionAuthorityPolicy",
  "artifact_slug": "transition-authority-policy",
  "stage_id": "SG-025",
  ...
  "generated_at": "2026-07-22T23:57:21.076738+00:00",
  ...
  "fail_closed": true,
  "materialization": {
    "path": "scaffolds/artifacts/SG-025/transition-authority-policy.artifact.json",
...
export const artifactId = "TransitionAuthorityPolicy";
export const stageId = "SG-025";
export const sourceDigest = "b028fceee0627859cefbb2ac10c7513203c812d96b8a70e2a0472ff7f031e6f4";
...
export function assertFunctionalImplementationAllowed() {
  if (implementationStatus !== 'FUNCTIONAL_IMPLEMENTATION_ALLOWED') {
    throw new Error(
      'FORGE_FUNCTIONAL_IMPLEMENTATION_NOT_AUTHORIZED:TransitionAuthorityPolicy'
    );
  }
