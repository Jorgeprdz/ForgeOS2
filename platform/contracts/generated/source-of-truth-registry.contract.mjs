...
// Source: scaffolds/artifacts/SG-023/source-of-truth-registry.artifact.json
// Artifact: SourceOfTruthRegistry
// Stage: SG-023
// Source SHA-256: 117958e2cd0dce0b7b0db5d90c6ebc23cff4d52540e091c907bd0c9a360af675

const contract = Object.freeze({
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "artifact_id": "SourceOfTruthRegistry",
  "artifact_slug": "source-of-truth-registry",
  "stage_id": "SG-023",
  ...
  "generated_at": "2026-07-22T23:50:15.487716+00:00",
  ...
  "fail_closed": true,
  "materialization": {
    "path": "scaffolds/artifacts/SG-023/source-of-truth-registry.artifact.json",
...
export const artifactId = "SourceOfTruthRegistry";
export const stageId = "SG-023";
export const sourceDigest = "117958e2cd0dce0b7b0db5d90c6ebc23cff4d52540e091c907bd0c9a360af675";
...
export function assertFunctionalImplementationAllowed() {
  if (implementationStatus !== 'FUNCTIONAL_IMPLEMENTATION_ALLOWED') {
    throw new Error(
      'FORGE_FUNCTIONAL_IMPLEMENTATION_NOT_AUTHORIZED:SourceOfTruthRegistry'
    );
  }
