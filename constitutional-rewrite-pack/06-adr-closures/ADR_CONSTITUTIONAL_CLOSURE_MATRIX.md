...
- `01-constitution/FORGE_CONSTITUTION_V3.md` incorporates the evidence, metric, authority, non-invention, product, policy, forecast, economic, advisor-first, rule-pack and human-decision boundaries expressed by the ADR set.
- `01-constitution/FORGE_CONSTITUTION_MAP.md` maps ADR-001 through ADR-018 into constitutional layers.
...
- `04-build-tree/FORGE_MASTER_BUILD_TREE.md` uses these boundaries across its current/historical area map.
